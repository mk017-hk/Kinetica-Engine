...
REM CUDA and TensorRT are OFF by default — enable with: set HM_USE_CUDA=ON
if not defined HM_USE_CUDA set HM_USE_CUDA=OFF
if not defined HM_USE_TENSORRT set HM_USE_TENSORRT=OFF
set CMAKE_ARGS=!CMAKE_ARGS! -DHM_USE_CUDA=!HM_USE_CUDA! -DHM_USE_TENSORRT=!HM_USE_TENSORRT!
